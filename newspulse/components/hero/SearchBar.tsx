  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-2xl mx-auto">
      <div className="w-full max-w-2xl mx-auto bg-white rounded-full flex items-center overflow-hidden shadow-md border border-white">
        ...
        <button
          type="submit"
          className="bg-[var(--color-bright-purple)] text-black rounded-full px-6 h-12 flex-shrink-0 hover:opacity-90 transition-opacity flex items-center gap-2 font-semibold"
          aria-label="Search"
        >
